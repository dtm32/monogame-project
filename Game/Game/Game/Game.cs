...
namespace Game
{
  ...
  public class Game : Microsoft.Xna.Framework.Game
  {
    ...
    protected override void LoadContent()
    {
      ...
      tileArray[10].AddUnit(new RenegadeKnight(knightNoHelmetTexture));
      tileArray[13].AddUnit(new Crimson_Knight(crimsonKnightTexture));
      tileArray[14].AddUnit(new Dark_Knight(darkKnightTexture));
      ...
      selectedUnitPanel = new UnitPanel(skillActive, skillPassive, unitPanelSolid, new Vector2(graphics.GraphicsDevice.Viewport.Width, graphics.GraphicsDevice.Viewport.Height));
    }
